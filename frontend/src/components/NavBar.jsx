...
export const NavBar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <nav className='bg-white h-16 max-h-16 flex items-center justify-between px-8 border-b border-gray-200 shadow-sm w-full shrink-0 box-border'>      {/* IZQUIERDA: Botón Desplegable + Breadcrumbs */}
