...
export const updateListReq = async (boardId, listId, data) => {
  try {
    ...
    console.error('Error en updateListReq:', error.response?.data || error.message)
    throw error.response?.data || error
  }
}
...
export const reorderListsReq = async (boardId, lists) => {
  try {
    ...
    console.error('Error en reorderListsReq:', error.response?.data || error.message)
    throw error.response?.data || error
  }
}
...
export const deleteListReq = async (boardId, listId) => {
  try {
    ...
    console.error('Error en deleteListReq:', error.response?.data || error.message)
    throw error.response?.data || error
  }
}
